...
public class PageFactory {
	   ...
	   //우현이 전용
	   public String getPageByWh(int cPage, int numPerpage, int totalData,
		         String url, String empId) {
		      StringBuffer pageBar=new StringBuffer();
		      ...
		      pageBar.append("<script>");
		      pageBar.append("function fn_paging(pageNo){");
		      pageBar.append("location.assign('"+url+"?cPage='+pageNo+'&numPerpage="+numPerpage+"&empId="+empId+"');");
		      pageBar.append("}");
		      pageBar.append("</script>");
