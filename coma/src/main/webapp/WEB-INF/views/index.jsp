                    ...
                    <thead class="thead-light">
                       ...
                       <tbody class="list">
                          <c:forEach var="mainNotice" items="${mainNotice}">
                              <tr>
                                 <td><c:out value="${mainNotice.boardNo }"/></td>
                                  <td><a href="/board/freePost?boardNo=${mainNotice.boardNo }"><c:out value="${mainNotice.boardTitle}"/></a></td>
                                  <td><c:out value="${mainNotice.boardDate}"/></td>
                              </tr>
                             </c:forEach>
                       </tbody>
                 </table>
